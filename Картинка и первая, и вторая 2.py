...
def house(x, y, w=300, l=400):
    ...
    d.rect(screen, fasade_color, (x, y - l, w, l), 0)
    ...
    # draw long windows
    d.rect(screen, longwindow_color, (x + (35 / 300) * w, y - l, (30/300)*w, (170/400)*l), 0)
    d.rect(screen, longwindow_color, (x + (35 / 300) * w + (30 / 300) * w + (25 / 300) * w, y - l, (30/300)*w, (170/400)*l), 0)
    d.rect(screen, longwindow_color, (x + ((35 / 300) + (30 / 300) + (25 / 300) + (30 / 300) + (35 / 300)) * w, y - l, (30/300)*w, (170/400)*l), 0)
    d.rect(screen, longwindow_color, (x + ((35 / 300) + (30 / 300) + (25 / 300) + (30 / 300) + (35 / 300) + (30/300) + (45/300))*w, y - l, (30/300)*w, (170/400)*l), 0)

    # draw balcony
    x_of_balcony = x - (30/300)*w
    y_of_balcohy = y - balcony_h
    between_balcas = (37/300)*w  # don't change it (иначе балкон уедет)
    d.rect(screen, balcony_color, (x_of_balcony, y_of_balcohy, w + (60/300)*w, (30/400)*l), 0)
    d.rect(screen, balcony_color, (x_of_balcony + (15/300)*w, y_of_balcohy - (30/400)*l, (10/300)*w, (30/400)*l + 2), 0)
    for i in range(1, 6):
        xx = x_of_balcony + (15/300)*w + i * between_balcas + (i - 1) * (20/300)*w
        d.rect(screen, balcony_color, (xx, y_of_balcohy - (30/400)*l, (20/300)*w, (30/400)*l + 2), 0)
    d.rect(screen, balcony_color, (x_of_balcony + (15/300)*w + 6 * between_balcas + (6 - 1) * (20/300)*w - (2/300)*w, y_of_balcohy - (30/400)*l, (10/300)*w, (30/400)*l + 2),0)
    d.rect(screen, balcony_color, (x_of_balcony + (25/300)*w, y_of_balcohy - (50/400)*l, w + (10/300)*w + 1, (20/400)*l), 0)

    # draw roof
    d.polygon(screen, roof_color, ((x - (30/300)*w, y - l - 1), (x + (20/300)*w, y - l - 1), (x + (20/300)*w, y - l - (40/400)*l)))
    d.polygon(screen, roof_color, ((x + w + (30/300)*w, y - l - 1), (x + w - (20/300)*w, y - l - 1), (x + w - (20/300)*w, y - l - (40/400)*l)))
    d.rect(screen, roof_color, (x + (20/300)*w, y - l - (40/400)*l, w - (40/300)*w, (40/400)*l), 0)
...
def picture_second():
    ...
    for i in range(4):
        ...
        d.ellipse(surface1, (ri(140, 200), 128, 128), (0, 0, 500*k, 70*k))
    ...
    for i in range(4):
        k = 0.7 + 0.1 * i
        d.surface1 = pygame.Surface((300 * k, 200 * k))
        if ri(0, 1) == 0:
